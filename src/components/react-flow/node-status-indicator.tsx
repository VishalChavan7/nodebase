...
export const SpinnerLoadingIndicator = ({
  ...
  return (
    <div className="relative">
      <StatusBorder className="border-blue-700/50">{children}</StatusBorder>
  ...
  return (
    <>
      ...
      `}
        ...
        >
          <div className="spinner rounded-full bg-[conic-gradient(from_0deg_at_50%_50%,_rgba(130,160,255,0.5)_0deg,_rgba(42,138,246,0)_360deg)]" />
        </div>
      </div>
      {children}
    </>
